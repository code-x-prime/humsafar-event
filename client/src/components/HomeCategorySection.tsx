...
export function HomeCategorySection({ section }: { section: HomeSection }) {
  return (
    <section className="border-t border-(--ink-100) py-7 sm:py-10">
      <div className="mx-auto max-w-7xl px-4">
        <div className="flex items-end justify-between gap-4">
          <div>
            <h2 className="font-display text-xl font-semibold text-(--navy-800) sm:text-2xl">{section.name}</h2>
