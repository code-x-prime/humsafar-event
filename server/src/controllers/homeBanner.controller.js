import * as bannerService from '../services/homeBanner.service.js';
...
export const create = async (req, res) => {
  ...
  req.auditContext = { entity: 'HomeBanner', entityId: banner.id, after: banner };
...
export const reorder = async (req, res) => {
  ...
  req.auditContext = { entity: 'HomeBanner', entityId: 'bulk-reorder' };
  return success(res, { message: 'Banners reordered successfully' });
};

export const remove = async (req, res) => {
  const banner = await bannerService.remove(req.params.id);
  req.auditContext = { entity: 'HomeBanner', entityId: banner.id, before: banner };
